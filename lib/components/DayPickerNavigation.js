...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iconArrowLeft = __webpack_require__(35);

	var _iconArrowLeft2 = _interopRequireDefault(_iconArrowLeft);

	var _iconArrowRight = __webpack_require__(36);
	...
	function DayPickerNavigation(props) {
	  ...
	  if (!navPrevIcon) {
	    ...
	    navPrevIcon = isVertical ? _react2['default'].createElement(_chevronUp2['default'], null) : _react2['default'].createElement(_iconArrowLeft2['default'], null);
	  }
	  if (!navNextIcon) {
	    isDefaultNavNext = true;
	    navNextIcon = isVertical ? _react2['default'].createElement(_chevronDown2['default'], null) : _react2['default'].createElement(_iconArrowRight2['default'], null);
	  }
	    ...
	    value: function () {
	      function render() {
	        return _react2["default"].createElement(
	          "svg",
	          _extends({ width: "32", height: "32", viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg" }, this.props),
	          _react2["default"].createElement(
	            "title",
	            null,
	            "EB6B8087-C2CA-4ED3-95B3-CC9E6E99D5B9"
	          ),
	          _react2["default"].createElement("path", { d: "M19 10l-6 6 6 6", strokeWidth: "2", stroke: "#6734BA", fill: "none", strokeLinecap: "square" })
	        );
	      }
	      ...
	      function render() {
	        return _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "title",
	            null,
	            "B3603545-C036-4B8C-A856-35B13F8A8AE7"
	          ),
	          _react2["default"].createElement("path", { d: "M13 10l6 6-6 6", strokeWidth: "2", stroke: "#6734BA", fill: "none", strokeLinecap: "square" })
	        );
	      }
