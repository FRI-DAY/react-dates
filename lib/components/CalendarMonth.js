	  ...
	  _createClass(CalendarMonth, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var yearTitle = month.format(yearFormat);
	        ...
	        return _react2['default'].createElement('div', { className: calendarMonthClasses, 'data-visible': isVisible }, _react2['default'].createElement('table', null, _react2['default'].createElement('caption', { className: 'CalendarMonth__caption js-CalendarMonth__caption' }, _react2['default'].createElement('span', { className: 'CalendarMonth__caption--month' }, monthTitle), _react2['default'].createElement('span', { className: 'CalendarMonth__caption--year' }, yearTitle)), _react2['default'].createElement('tbody', { className: 'js-CalendarMonth__grid' }, weeks.map(function (week, i) {
